...
export default class Chef extends Component<CounterProps, CounterState> {
  constructor(props:{message : "s"}) {
    super(props);
    this.state = {
      count: 2,
    };
...
//   function ReadyModal(props: { show: boolean; table: number }) {
//     return props.show ? (
...
//               <button
//                 onClick={() => <ReadyModal show={true} table={2} />}
