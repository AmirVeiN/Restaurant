    ...
    return (
        <div className="flex flex-col px-5 pt-3">
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="p-1 flex flex-row items-center justify-center 
                space-x-2 rtl:space-x-reverse">
                    <BiRestaurant className="text-red text-xl" />
                    <p className=" text-text">رستوران گل یخ</p>
                </div>
                <button onClick={()=> router.push('/payment')} className="text-xl shadow-sm p-2 shadow-red bg-red rounded-xl text-primary">
                    <MdShoppingBasket />
                </button>
            </div>
        </div>
